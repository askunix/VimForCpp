...
if !exists("g:DoxygenToolkit_briefTag_func_pre")
    let g:DoxygenToolkit_briefTag_func_pre = "@brief"
endif
...
" following 3 lines added by xschen
if !exists("g:DoxygenToolkit_paramName_post")
  let g:DoxygenToolkit_paramName_post = ""
endif
...
function! <SID>DoxygenCommentFunc()
  ...
  if( g:DoxygenToolkit_compactOneLineDoc =~ "yes" && l:doc.returns != "yes" && len( l:doc.params ) == 0 )
    ...
    exec "normal O".strpart( s:startCommentTag, 0, 1 )
    exec "normal A".strpart( s:startCommentTag, 1 ).g:DoxygenToolkit_briefTag_func_pre.g:DoxygenToolkit_briefTag_post
  else
    let s:compactOneLineDoc = "no"
    let l:insertionMode = s:StartDocumentationBlock()
    exec "normal ".l:insertionMode.s:interCommentTag.g:DoxygenToolkit_briefTag_func_pre.g:DoxygenToolkit_briefTag_post
  endif
  if( l:doc.name != "None" )
  ...
  " max len of params, by xschen
  let l:max_len = 0
  for param in l:doc.params
	  if (strlen(param) > l:max_len)
		  let l:max_len = strlen(param)
	  endif
  endfor
  ...
  for param in l:doc.params
	...
	" by xschen
	let l:init_len = strlen(param)
	let l:spaces = ""
	while l:init_len < l:max_len
		let l:spaces = l:spaces." "
		let l:init_len = l:init_len + 1
	endwhile
    exec "normal o".s:interCommentTag.g:DoxygenToolkit_paramTag_pre.g:DoxygenToolkit_paramTag_post.param.l:spaces.g:DoxygenToolkit_paramName_post
  endfor
